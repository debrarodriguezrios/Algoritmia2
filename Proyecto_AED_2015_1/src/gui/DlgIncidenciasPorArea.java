	...
	void buscarIncidencia() {
		...
		for (int i=0; i<Proyecto_AED_2015_1.au.tamaño(); i++) {							
			...
			if (posArea() == x.getArea())
				for (int j=0; j<Proyecto_AED_2015_1.ai.tamaño(); j++) {
					...
					if (x.getCodigo() == y.getCodigoUsuario()) {
						...
						imprimir("Tiempo estimado de solución en horas :  " + y.getTiempoEstimadoSol());
						imprimir("Tiempo real de solución en horas     :  " + y.getTiempoRealSol());
