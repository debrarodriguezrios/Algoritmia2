...
public class DlgTipoIncidencia extends JDialog implements ActionListener, WindowListener {
	...
	public DlgTipoIncidencia() {
		...
		scpScroll.setViewportView(tblTipoIncidencia);
		tblTipoIncidencia.setModel(Proyecto_AED_2015_1.ati);
	...
	protected void actionPerformedBtnSalir(ActionEvent e) {
		Proyecto_AED_2015_1.ati.grabarTipoIncidencias();		
		dispose();
	}
	...
	private void lanzarFormulario() {
		...
		if (tipoOperacion != 0)
			daa.cargarTipoIncidencia(Proyecto_AED_2015_1.ati.obtener(tblTipoIncidencia.getSelectedRow()));
		daa.setVisible(true);
	}
