...
public class ArregloIncidencias extends AbstractTableModel {
	...
	private void cargarIncidencias() {
		try {
			...
			while ((linea = br.readLine()) != null) {
				...
				adicionar(new Incidencia(codigo,codigoUsuario,codigoEspecialista,
						                 codigoTipoIncidencia,descripcion,
						                 comentario,tiempoEstimadoSol,
						                 tiempoRealSol,fechaRegistro,
						                 fechaInicioAtencion,
						                 fechaFinAtencion,estado));
			}
			br.close();
		}
		catch (Exception e) {
	...
	public Object getValueAt(int fila, int columna) {
		...
		switch (columna) {
			...
			case 6:
				return x.getTiempoEstimadoSol();
			case 7:
				return x.getTiempoRealSol();
			case 8:
