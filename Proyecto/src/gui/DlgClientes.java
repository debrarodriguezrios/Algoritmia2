...
public class DlgClientes extends JDialog implements ActionListener, WindowListener {
	...
	public DlgClientes() {
		...
		tblClientes.setModel(Proyecto.ac);   
	...
	private void ajustarAnchoColumnas() {
		...
		tcm.getColumn(1).setPreferredWidth(anchoColumna(32));  
		tcm.getColumn(2).setPreferredWidth(anchoColumna(22)); 
		tcm.getColumn(3).setPreferredWidth(anchoColumna(22));  
		tcm.getColumn(4).setPreferredWidth(anchoColumna(32));  
		tcm.getColumn(5).setPreferredWidth(anchoColumna(22));  
		tcm.getColumn(6).setPreferredWidth(anchoColumna(22));  
		tcm.getColumn(7).setPreferredWidth(anchoColumna(16));  
		tcm.getColumn(8).setPreferredWidth(anchoColumna(22));  
		tcm.getColumn(9).setPreferredWidth(anchoColumna(22));  
		tcm.getColumn(10).setPreferredWidth(anchoColumna(15));  
		tcm.getColumn(11).setPreferredWidth(anchoColumna(15));  
	...
	private void lanzarFormulario() { //////////////ver
		DlgClientesActividad dea = new DlgClientesActividad();
		...
		if(tipoOperacion > 0 && Proyecto.ac.tamaño()==0){
			Lib.mensajeError(this, "No existen clientes");
		}else{
			if(tipoOperacion > 0){
				dea.cargarCliente(Proyecto.ac.obtener(tblClientes.getSelectedRow()));
			}
			dea.setVisible(true);
		}
	}
